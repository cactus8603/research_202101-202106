...
# 讀取股吧內容
stock = openpyxl.load_workbook("./2017/2017股吧.xlsx")
stock_sheet = stock['工作表1']

# 讀取產業代碼
industrial_code = openpyxl.load_workbook("./2017/產業代碼2017.xlsx")
...
# 存檔
stock.save(r'./Result/2017_加入產業代碼股吧.xlsx')
delete_stock.save(r'./Result/2017_金融產業股吧名單.xlsx')
new_stock.save(r'./Result/2017_刪除金融產業後剩餘股吧名單.xlsx')
